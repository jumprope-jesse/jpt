...
tags: ['Running']
created: 2025-10-08T02:31:00.000Z
---

# Seeing like a software company

## Overview (from Notion)
- Balancing Legibility and Illegibility: Understanding the tension between structured processes and the necessity for flexibility can help you navigate your company's growth while maintaining creativity and efficiency.

- Efficiency vs. Bureaucracy: Recognize that while larger organizations often prioritize legibility for planning and accountability, it can stifle innovation. Reflect on how you can maintain a balance in your own company.

- Backchannels and Relationships: The concept of utilizing informal communication channels may resonate with you—leveraging relationships to expedite decisions or changes can be crucial in a fast-paced environment.

- Sociopaths vs. Clueless: Acknowledge the different roles in organizations. Understanding the dynamics of your team can help you foster a collaborative environment, avoiding the pitfalls of purely formal structures.

- Enterprise Deals & Legibility: If you're targeting large clients, ensuring your company is legible can be essential for building trust, even if it means sacrificing some efficiency.

- Temporary Zones of Illegibility: Consider implementing temporary teams for urgent issues to bypass some bureaucratic hurdles while still retaining overall structure.

- Alternate Views: Some argue that processes should be streamlined to eliminate inefficiencies entirely. Reflect on whether a pure legibility approach might limit your team's agility and creativity.

- Personal Reflection: Think about how these ideas apply to your work-life balance. Finding a way to integrate both legible planning and the flexibility for spontaneous, creative work can enhance both your professional and personal life.

## AI Summary (from Notion)
Modern organizations prioritize "legibility" to control and measure work, often at the expense of efficiency. This creates a reliance on "illegible" work, which is essential but hard to track. In software companies, legibility allows for planning and enterprise deals, but can hinder immediate problem-solving. Large companies often create temporary zones for illegible work to address urgent issues, while backchannels facilitate quick communication. Understanding the balance between legibility and illegibility is crucial for navigating organizational dynamics and improving efficiency.
...
1. However, these organizations are dependent on a huge amount of “illegible” work: work that cannot be tracked or planned for, but is nonetheless essential.
1. Increasing legibility thus often actually lowers efficiency - but the other benefits are high enough that organizations are typically willing to do so regardless.
...
1. They take that idea to the Product org, where it goes into the “planning” stage. Meetings are had about the idea.
1. Once the Product org formally decide they want to do it, the idea then passes to the Engineering org: into the hands of some council of engineering architects, who are tasked with the initial technical review. They figure out how it fits into the general engineering priorities and give it a very rough time estimate.
1. The VPs and senior managers in the engineering org then negotiate which team will own the work. Often this is a semi-technical, semi-organizational decision (because which service the work should fall into is at least partly a technical question).
1. Finally the work lands on the team. It enters the team planning backlog, where the team technical lead breaks it out into smaller pieces of work.
1. Those smaller pieces of work enter the team ticket backlog, and are estimated in the team’s weekly planning meeting.
1. Finally some of those pieces of work make it into the next sprint, and are picked up by an engineer who can actually do it.
