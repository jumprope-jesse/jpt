...
tags: ['Running']
created: 2024-02-24T18:19:00.000Z
---

# How To Not Die By A Thousand Cuts. Or, How To Think About Software Quality.

## AI Summary (from Notion)
- Quality in Software: Quality is defined as the experience of the process, emphasizing the importance of performing processes gracefully and leaving things better than they were found.
- Software Evolution: Software is conceptually malleable and requires constant maintenance and adaptation to the changing world, contrasting with more static products.
- Responsibility for Quality: Quality Assurance should not only fall on QA teams but should be a collective responsibility involving all stakeholders, including product managers, developers, and even executives.
- Risks in Linear Workflows: Traditional linear workflow models in software development lead to compounding risks, as errors and quality issues often go unnoticed until too late.
- Death by a Thousand Cuts: Every complaint, bug, or app crash represents a "cut" to quality, which accumulates over time, highlighting the need for a holistic approach to quality assurance.
- Creating vs. Destroying Quality: Strategies to destroy quality include mislabeling testing as QA, fostering blame culture, and prioritizing speed over quality. Conversely, creating quality involves collaboration, shared responsibility, and a culture of learning.
- Perspective Matters: Gaining diverse perspectives is crucial for understanding and improving quality, suggesting that discomfort and suffering can lead to constructive outcomes.
- Resources for Improvement: The author provides a list of resources for further learning about systems thinking, software complexity, and personal development, emphasizing the importance of continued education and adaptation.
- Personal Journey: The author reflects on their personal growth and learning over two decades, acknowledging mistakes and the influence of others in shaping their understanding of software quality.

## Content (from Notion)

Contents   What is the nature of software products? Whom to hold responsible for Software Quality Assurance? Why? Is it different for different kinds of products? How to destroy Quality? How to create Quality? The first skill is to learn to suffer constructively. Caveats, mea culpa, etc.
...
- Further normalise all kinds of deviance.
This was just a shortlist of things I recalled while writing this post. Think up as many ways as you can. #protip for inspiration: read CIA's now-declassified Simple Sabotage Field Manual. Pay special attention to part 11: General Interference with Organisations and Production.
...
- Thinking in Systems is a great primer.
Software complexity:
...
- Critical Chain Project Management (The Goal is a fine place to start, if you have no idea what CCPM is.)
...
- Stuff from The School of Life (corny name, yes, but give it a chance :)
I recently discovered Gene Kim's podcast, The Idealcast. Gene is gathering fantastic people and resources in one place. Definitely have a look-see.
