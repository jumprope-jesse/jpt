...
tags: ['Running']
created: 2025-10-08T01:29:00.000Z
---

# Vibe engineering

## Overview (from Notion)
- Vibe engineering contrasts with vibe coding, emphasizing accountability and professionalism in software development with AI.
- It highlights the complexity of integrating AI tools effectively, which might resonate with your experience as a founder managing diverse projects.
- The rise of coding agents suggests an evolution in software development, requiring not just coding skills but also strategic planning and documentation.
- Your role might evolve to include managing AI tools and agents, akin to overseeing a team, but with unique challenges like ensuring quality and context.
- The discussion around the term “vibe engineering” reflects a cultural shift in tech, where playful language meets serious implications—an approach you might appreciate.
- An alternative view could be skepticism towards AI tools, fearing they might undermine the craft of traditional programming, promoting a debate about the future of software engineering.
- Balancing work and family life in NYC can be intensified by these rapid changes in tech; staying ahead or adapting could lead to new opportunities or stress.

## AI Summary (from Notion)
Vibe engineering refers to a sophisticated approach to software development using AI tools, contrasting with the more casual vibe coding. It emphasizes accountability, effective practices like automated testing, planning, documentation, and version control. Experienced engineers can leverage coding agents to enhance productivity, but must maintain high standards in research, quality assurance, and project estimation. The term aims to reclaim the concept of "vibes" in a constructive way, highlighting the complexity and expertise required in modern software engineering with AI.
...
I also like that this is cheeky and likely to be controversial. This whole space is still absurd in all sorts of different ways. We shouldn’t take ourselves too seriously while we figure out the most productive ways to apply these new tools.
 ...
 definitions 29   software-engineering 59   ai 1604   generative-ai 1413   llms 1382   ai-assisted-programming 246   vibe-coding 46   coding-agents 62 
