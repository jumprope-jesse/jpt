...
tags: ['Running']
created: 2026-01-11T06:40:00.000Z
---

# Code And Let Live · The Fly Blog

## Overview (from Notion)
- Embrace the shift from traditional sandbox environments to more flexible computing solutions like Sprites; this aligns with a modern approach to software development.
- Consider how durable and accessible computing resources can streamline both your work as a software engineer and your personal projects at home, like managing your kids' devices.
- Recognize the potential for more creative freedom and less overhead in managing development environments, which can enhance productivity and innovation.
- Reflect on how this technology could empower non-professional developers (like your kids) to engage with software creation, breaking down barriers to entry.
- Challenge the conventional view that only professional developers should gatekeep application development; the future may allow more direct user involvement in software evolution.
- Think about the implications of disposable computers in your life—how might they simplify your daily tasks or lead to new ideas for family-oriented projects?

## AI Summary (from Notion)
Fly.io introduces "Sprites," a new type of cloud computer that allows users to create and manage lightweight, durable instances quickly and easily. Unlike traditional ephemeral sandboxes, Sprites provide persistent storage and can be created in seconds, making them ideal for both professional developers and non-experts. The author argues that the current approach to software development, which relies on stateless containers, is limiting and suggests that allowing agents to operate on real computers will enhance productivity and innovation. The shift from sandboxes to disposable computers is positioned as a necessary evolution in the software development landscape.
...
You can create a couple dozen Sprites right now if you want. It’ll only take a second.  Make a Sprite. → 
