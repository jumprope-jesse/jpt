...
tags: ['Running']
created: 2024-03-06T04:10:00.000Z
---

# Things You Should Never Do, Part I – Joel on Software

## AI Summary (from Notion)
- Main Theme: The pitfalls of rewriting code from scratch and the advantages of maintaining and improving existing code.
- Argument Against Rewrites:
- Significant technological advancements may justify a rewrite, but they are often not enough to outweigh the benefits of existing code.
- Old code accumulates knowledge through bug fixes and real-world usage, which is lost in a rewrite.
- Rewriting can lead to loss of market leadership and increased vulnerability to competitors.
- Common Misconceptions:
- Programmers often perceive old code as a "mess" without recognizing its tested reliability.
- Architectural, efficiency, and aesthetic issues can often be resolved without a complete rewrite.
- Gradual Improvement: Incremental updates and refactoring can improve code quality without starting from scratch.
- Developer Morale: Working with legacy code can be frustrating, but a rewrite does not guarantee an improvement in developer satisfaction or project attractiveness.
- Historical Context: Examples of companies (Netscape, Borland, Microsoft) that suffered due to strategic mistakes in rewriting code illustrate the risks involved.
- Final Takeaway: The mantra of "build one to throw away" is dangerous for commercial applications; careful maintenance and gradual improvements are often the better approach.
