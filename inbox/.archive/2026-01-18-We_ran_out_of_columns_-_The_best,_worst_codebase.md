...
tags: ['Running']
created: 2024-08-04T14:08:00.000Z
---

# "We ran out of columns" - The best, worst codebase

## AI Summary (from Notion)
- Dual Nature of Codebases: The author reflects on their first job where they experienced both the best and worst aspects of a codebase, highlighting the complexity and chaos of legacy systems.
- Database Limitations: A pivotal issue was running out of columns in a SQL Server database, leading to the creation of a second, unwieldy table, Merchants2.
- Unique Practices: The company had unconventional practices, such as a manual calendar table that dictated login capabilities and an employees table that was reset daily using CSV uploads.
- SequenceKey Table: A single-row table to generate unique IDs, showcasing the unexpected creativity in handling database limitations.
- Codebase Composition: The codebase consisted of mixed technologies (VB, C#, JavaScript frameworks) with a lack of coherent structure, resulting in a chaotic but functional environment.
- Gilfoyle's Legacy: A former developer, known for creating untracked one-off applications, left behind a legacy of unmaintained code and bugs.
- Innovative Solutions: A senior developer improved the performance of a critical application page significantly, demonstrating the potential for rapid fixes in chaotic systems.
- Decoupling and Flexibility: The chaotic nature of the codebase inadvertently led to a more flexible and decoupled architecture, allowing developers to create new features without extensive overhead.
- Nostalgia for Simplicity: The author expresses a longing for the simplicity and direct user feedback experienced in their early career, contrasting it with the structured but cumbersome approaches of modern development.
- Overall Reflection: The author appreciates the spontaneity and adaptability found in a "beautifully ugly" codebase, which fostered innovation despite its flaws.
