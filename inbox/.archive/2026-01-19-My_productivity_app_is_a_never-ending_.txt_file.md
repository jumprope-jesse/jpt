...
tags: ['Running']
created: 2024-02-20T01:52:00.000Z
---

# My productivity app is a never-ending .txt file

## AI Summary (from Notion)
- Productivity System: The author uses a single text file to manage their productivity, having relied on it for 14 years.
- Daily Routine: Every night, the author appends the next day's calendar items to the text file as a to-do list.
- Record-Keeping: The daily lists serve as both to-do lists and records of accomplishments, with over 51,690 lines documenting their work.
- Flexibility: A text file allows for easy modifications, quick searches, and a clear overview of tasks and completed items.
- Email Management: The author uses a simple flagging system for email prioritization, focusing on handling important tasks instead of maintaining an empty inbox.
- Shortcuts and Tags: The author employs consistent writing styles and tag systems for easy retrieval of information.
- Workload Control: The process allows the author to manage their workload effectively, making adjustments to commitments as needed.
- Personal Reflection: The system has its drawbacks, such as occasionally missing interesting research questions, but overall helps maintain productivity without feeling overwhelmed.
- Open for Feedback: The author invites readers to share their experiences or suggestions regarding the productivity system.
...
1. do scheduled things on that list during the day
1. when I have free (unscheduled) time, do the floating tasks on my list and work on Red-flagged emails
1. do a quick review of Orange/Yellow emails to see if they need any handling
1. copy the next day's calendar items to the bottom of the text file
