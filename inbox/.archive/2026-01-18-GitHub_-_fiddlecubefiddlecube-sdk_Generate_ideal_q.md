...
type: link
source: notion
url: https://github.com/fiddlecube/fiddlecube-sdk
notion_type: Software Repo
tags: ['Running']
created: 2024-06-26T01:25:00.000Z
---

# GitHub - fiddlecube/fiddlecube-sdk: Generate ideal question-answers for testing RAG

## AI Summary (from Notion)
- Project Overview: FiddleCube is a tool designed to generate an ideal question-answer dataset for testing Large Language Models (LLMs).
- Purpose: It helps ensure that LLMs are thoroughly tested prior to prompt or RAG upgrades, enhancing their performance and reliability.
- Installation: Users can install FiddleCube easily using a simple pip command.
- API Key: An API key is required for usage, which can be obtained from the FiddleCube dashboard.
- Dataset Generation:
- Users can input various contexts, and the tool generates relevant question-answer pairs.
- Generated questions include diverse types, such as simple queries and multiple-choice questions (MCQs).
- Dataset Importance: A high-quality dataset is critical for the testing, evaluation, and training of LLMs, as it ensures a wide range of queries and accurate responses.
- Continuous Updates: The dataset is auto-updated to reflect changes in prompts or RAG contexts, allowing for ongoing relevance and accuracy.
- Roadmap: Future plans include features like multi-turn conversations, evaluation metrics integration, and CI/CD pipeline setup.
- Contact: Users can book a demo or reach out for feature requests or feedback via provided contact information.
