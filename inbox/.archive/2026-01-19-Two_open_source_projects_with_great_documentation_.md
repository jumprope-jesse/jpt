...
tags: ['Running']
created: 2024-03-26T02:40:00.000Z
---

# Two open source projects with great documentation • johnjago.com

## Overview (from Notion)
- Good documentation is crucial for efficient collaboration in software projects, especially if you're leading a team or mentoring others.
- High-quality documentation saves time, allowing you to focus on building rather than explaining your codebase repeatedly.
- Learning from well-documented projects like esbuild and Redis can inspire you to improve your own documentation practices, making your code more accessible to contributors.
- Consider how good documentation can enhance your company's reputation and attract external contributions, which could be vital for growth.
- Balancing documentation with fast-paced development can be challenging; finding the right level of detail is key.
- Reflect on the long-term benefits of investing time in documentation now versus potential confusion and inefficiency later.
- Explore the idea that while thorough documentation is valuable, it's also important to adapt to the evolving needs of your projects and team.
- Consider the perspective that not every project requires exhaustive documentation; focus on what's necessary based on user needs and project scope.
- Emphasize the idea that clear documentation can serve as a tool for your own thought processes, helping clarify your own design decisions.

## AI Summary (from Notion)
esbuild and Redis are highlighted as examples of open source projects with exceptional documentation, emphasizing the importance of clear READMEs, architecture documents, and code comments for effective collaboration and user experience in software development.

## Content (from Notion)

23 March 2024 · all posts
...
esbuild is a JavaScript bundler created by Evan Wallace. It’s not important for this analysis to know what a bundler is, but webpack has a good explanation if you’re curious.
...
The short README for esbuild, with a logo, links, and a brief explanation of why someone would choose it over other bundlers.
...
The table of contents and introductory paragraph of the esbuild architecture documentation.
...
What’s impressive is that every entry is like this. Detailed explanation2, example code. Someone reading through the changes can understand the impact without referencing the actual code modifications.
...
Redis is an in-memory database. As with esbuild, any more explanation of what Redis does is out of scope for this post, but what is in scope for Redis is the level of detail in the documentation, specifically around its code and architecture.

### The Redis README: Introduction and architecture

The README shares many of the good characteristics of the esbuild README, with a couple differences.
...
However, the section which really shines is about the Redis internals.
