...
tags: ['Running']
created: 2025-05-25T02:55:00.000Z
---

# Reinvent the Wheel | Matthias Endler

## Overview (from Notion)
- Embrace the idea of reinventing the wheel to foster curiosity and exploration in your work and personal life.
- Consider that the process of creating something new can lead to valuable learning experiences, both for yourself and your children.
- Recognize that the advice against reinventing the wheel often stifles innovation; challenge this mindset in your projects.
- Reflect on how your experiences can inspire your kids to think creatively and tackle challenges instead of avoiding them.
- The importance of building prototypes quickly aligns with agile methodologies in software development, which can enhance your effectiveness as a founder.
- Explore the potential of teaching your children about technology and problem-solving through hands-on projects, reinforcing both their learning and your relationship.
- Understand that every project is an opportunity to learn about trade-offs in design and implementation, which can inform both your technical skills and parenting approaches.
- Alternative views might suggest that focusing on existing solutions is more efficient, but balance this with the need for continuous learning and growth.

## AI Summary (from Notion)
Reinventing the wheel fosters learning and innovation; it allows for deeper understanding, encourages exploration, and can lead to better solutions tailored to specific needs. However, it's important to balance this with reusing existing work for efficiency and impact.
