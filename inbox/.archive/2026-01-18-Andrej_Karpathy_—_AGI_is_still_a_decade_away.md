...
tags: ['Running']
created: 2025-10-18T00:37:00.000Z
---

# Andrej Karpathy — AGI is still a decade away

## Overview (from Notion)
- The discussion emphasizes the future of AI and how it will transform industries, including software engineering, which might resonate with your experience as a founder.
- Key ideas include:
- AGI Timeline: Andrej Karpathy suggests that true AGI is still a decade away, highlighting the incremental nature of technological advancement.
- Role of Education: The importance of creating educational frameworks that leverage AI for enhanced learning experiences, which could inspire your approach to mentoring or guiding others in your field.
- Cognitive Models: The idea that humans learn differently than machines, and that AI lacks cultural understanding, could inform how you design products or services.
- Self-Driving Analogies: Comparisons between self-driving tech and AI deployment in software engineering might provide insight into managing expectations and timelines in your projects.
- Cultural Creation: The potential for AI to create culture or collaborate among models could inspire innovative business ideas or new product offerings.
- Alternate viewpoints might include skepticism about the timeline for AGI and the potential for oversaturation in AI tools, which could affect your strategic decisions as a founder.

## AI Summary (from Notion)
Andrej Karpathy discusses the challenges of achieving AGI, emphasizing that it is still a decade away due to issues like reinforcement learning limitations and model collapse. He highlights the importance of continual learning and the need for AI to better mimic human learning processes. Karpathy also reflects on the evolution of intelligence, the role of education in the future, and the potential for AI to enhance human capabilities rather than replace them. He envisions a future where education is transformed by AI, making learning more accessible and engaging.
...
Embed: <https://www.youtube-nocookie.com/embed/lXUZvyajciY?rel=0&autoplay=0&showinfo=0&enablejsapi=0>
...
Ryan Serrato's avatar

Dickson Pau's avatar
