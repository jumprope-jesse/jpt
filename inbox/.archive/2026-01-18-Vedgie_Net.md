...
tags: ['Running']
created: 2024-07-17T05:50:00.000Z
---

# Vedgie Net

## Overview (from Notion)
- The concept of a Darwin Machine can inspire innovative thinking in software development, emphasizing evolution and adaptability in algorithms.
- The focus on understanding complex problems and solutions mirrors the challenges faced in entrepreneurship, where navigating uncertainty is key.
- The idea of spatiotemporal patterns could influence how you approach user experience design, making it more intuitive and responsive.
- Emphasizing constraints in scientific theory can lead to more creative problem-solving in both personal and professional life.
- The discussion about system one (quick intuition) vs. system two (deep thinking) can help balance decision-making in high-pressure situations, like running a startup.
- The theory highlights the importance of collaboration and communication, which can be applicable in team dynamics and family life.
- Alternate viewpoints may include skepticism about the practicality of applying biological concepts to AI, offering a chance to explore both sides of the debate.
- Consider how the principles of recombination in evolution could reflect on parenting, where mixing traits and influences leads to unique outcomes in your children’s development.

## AI Summary (from Notion)
Exploration of the Darwin Machine theory, which suggests that the brain uses evolution to navigate a complex problem space through minicolumns and cortical columns, allowing for both quick and deep thinking, and emphasizing the role of recombination in creativity and memory formation.
...
1. Both memory and processing are massively parallel.
1. Computation uses spatio-temporal patterns.
1. But memory is spatial.
