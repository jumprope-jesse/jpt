...
type: link
source: notion
url: https://www.rainforestqa.com/blog/building-reliable-systems-out-of-unreliable-agents
notion_type: Tech Deep Dive
tags: ['Running']
created: 2024-04-09T23:52:00.000Z
---

# Building reliable systems out of unreliable agents | Rainforest QA

## AI Summary (from Notion)
- Main Topic: Building reliable systems using AI agents that may not be inherently reliable.

- Key Steps in Developing AI Systems:
- Start with simple prompts for problem-solving.
- Establish an evaluation (eval) system for prompt engineering to improve performance.
- Deploy the AI system with observability to gather user feedback and make improvements.
- Invest in Retrieval Augmented Generation (RAG) to dynamically enhance prompts with relevant information.
- Fine-tune models based on collected data for improved performance.

- Complementary Agents:
- Use multiple specialized agents (e.g., planner and verifier) to enhance reliability.
- Each agent handles different aspects of the task, leading to more consistent results.

- User Feedback:
- Prioritize gathering real user data and feedback to inform ongoing improvements.
- Transparency about the system's reliability with users is crucial.

- Iterative Process:
- The development of AI systems is inherently iterative; expect to refine and improve continuously based on testing and user feedback.

- Challenges:
- AI agents often require prompt engineering to overcome their limitations.
- Fine-tuning models can be complex and is often seen as a trade-off in terms of effort versus potential improvement.

- Hot Takes:
- Relying solely on one AI agent can lead to inconsistencies; using multiple agents can mitigate this risk.
- Developing AI products involves a mix of applied research and engineering, requiring flexibility and adaptability.

- Interesting Facts:
- The author shares personal experiences and practical tips based on years of developing a QA AI system.
- The importance of structured data and validation sets in improving AI output quality is emphasized.
