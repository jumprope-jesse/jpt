...
tags: ['Running']
created: 2024-03-01T15:34:00.000Z
---

# ARCHITECTURE.md

## AI Summary (from Notion)
- Importance of ARCHITECTURE Document: Essential for open-source projects with 10k-200k lines of code alongside README and CONTRIBUTING.
- Knowledge Gap: Core developers have a mental map of the project; occasional contributors lack this understanding, leading to inefficiencies.
- Time Efficiency: Familiarity with the project architecture can significantly reduce the time to write patches and locate necessary code changes.
- Low-Effort, High-Leverage: A well-structured ARCHITECTURE document helps new contributors quickly understand the project.
- Content Guidelines:
- Provide a high-level overview of the problem being solved.
- Include a codemap detailing coarse-grained modules and their relationships.
- Avoid frequent updates; only include stable information unlikely to change often.
- Name significant files, modules, and types without linking them.
- Architectural Invariants: Clarify important invariants in the architecture that might not be obvious from the code.
- Boundaries: Highlight boundaries between layers and systems, which can inform implementation choices.
- Cross-Cutting Concerns: Address these concerns in a separate section after the codemap.
- Example Reference: Suggests looking at the architecture.md from rust-analyzer for a good example of implementation.
