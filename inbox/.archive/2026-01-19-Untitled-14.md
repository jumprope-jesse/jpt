...
tags: ['Running']
created: 2024-03-19T12:11:00.000Z
---

# Untitled

## Overview (from Notion)
- Social Technology Experiment: Community Notes represents an attempt to leverage community engagement for better information dissemination, which could resonate with your interest in improving communication within your family or workplace.

- Algorithmic Insights: The discussion of the ranking algorithm might inspire you to think about how algorithms can be applied in your software projects, particularly in enhancing user interaction or feedback systems.

- Political Neutrality: The critique of Community Notes' binary left-right focus could prompt reflections on how your company might navigate political discussions, ensuring a more inclusive environment.

- User Engagement: The need for users to demonstrate "helpfulness" before contributing could inform your approach to team dynamics and leadership, emphasizing the value of constructive collaboration.

- Community Dynamics: Understanding how collective ratings can skew perceptions might provide insight into managing team feedback or customer reviews, especially in a startup environment.

- Diverse Perspectives: The critique of using cross-partisan consensus as a quality metric might encourage you to think about how to incorporate diverse viewpoints in your projects to avoid echo chambers.

- Complexity and Clarity: The complexities of the algorithm could reflect the challenges you face in balancing detailed technical specifications with clear communication to your team and stakeholders.

- Misinformation Concerns: The implications of misinformation in digital spaces could resonate with your experiences navigating information technology and its effects on public discourse.

- Alternative Approaches: Consider exploring other community-driven moderation systems that avoid binary divisions, which could lead to innovative solutions in your projects or community initiatives.

## AI Summary (from Notion)
Exploration of Community Notes on X (formerly Twitter) reveals its algorithm promotes cross-partisan support for fact-checking notes, though it faces criticism for being insufficient compared to traditional moderation. The ranking algorithm uses user ratings to determine helpfulness, with a focus on ideological balance, but may inadvertently reinforce partisan divides. Concerns about the complexity and potential for manipulation are also noted.
...
- fu, fn: Factor vectors for u and n. The dot product of these vectors is intended to describe the “ideological agreement” between a user and a note. These vectors are currently one dimensional (each just a single number), though the algorithm is in principle agnostic to the number of dimensions.
