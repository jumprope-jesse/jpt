...
tags: ['Running']
created: 2024-04-30T13:25:00.000Z
---

# Amazon Q Business, now generally available, helps boost workforce productivity with generative AI | Amazon Web Services

## AI Summary (from Notion)
- Introduction of Amazon Q Business: A generative AI-powered assistant designed to enhance workforce productivity by answering questions, providing summaries, generating content, and completing tasks securely.
- General Availability: Amazon Q Business is now generally available with new features, including custom plugins and Amazon Q Apps.
- Key Features:
- End-user Experience: Web-based chat assistant for real-time Q&A, content creation mode for creative tasks without accessing enterprise data.
- Data Connectors: Over 40 pre-built data connectors for seamless integration with enterprise data sources like Amazon S3, Microsoft 365, and Salesforce.
- Admin Controls: Global control options for generating responses from either enterprise data or LLMs, with the ability to block specific topics.
- Security and Management: Enhanced security measures using AWS IAM Identity Center for user identity management, ensuring secure connections and data handling.
- Amazon Q Apps Preview: Users can create custom generative AI-powered applications easily without coding skills, enhancing organizational productivity.
- Pricing Plans: Two subscription options: Amazon Q Business Lite ($3/user/month) and Amazon Q Business Pro ($20/user/month), with a free trial available.
- Launch Regions: Initially available in the US East (N. Virginia) and US West (Oregon) regions.
- Interesting Facts:
- The AI assistant can analyze trends and engage in dialog based on enterprise data.
- Organizations can share and modify applications within their catalog, promoting innovation and collaboration.
