...
type: link
source: notion
url: https://dynomight.substack.com/p/advice
notion_type: Tech Deep Dive
tags: ['Running']
created: 2024-07-30T15:28:00.000Z
---

# Why doesn't advice work? - DYNOMIGHT INTERNET NEWSLETTER

## Overview (from Notion)
- Relevance of Advice: You often seek advice in tech and parenting but may find that much of it doesn’t resonate due to your unique circumstances. This piece explores why advice is frequently ignored, highlighting the disconnect between good intentions and practical implementation.

- Understanding User Needs: Just as in software development, understanding the user's context is crucial. The article emphasizes that advice can be ineffective if the advisor doesn’t fully grasp the recipient's situation—similar to how user feedback shapes product features.

- Cognitive Bias: The idea that people filter out advice they don’t want to follow can relate to personal decisions in both family dynamics and business strategy. Recognizing this bias can lead to more effective communication with your family and team.

- Subjectivity of Experience: Advice that works for one person may not work for another. This notion can be applied to your approach in both parenting your kids and leading your company, where individual experiences greatly influence outcomes.

- Alternative Perspectives on Action: The article proposes that procrastination or inaction isn’t just about laziness; it’s tied to emotional responses. Consider how this might apply when motivating your team or encouraging your children.

- Consumerism in Advice: The suggestion to focus on actionable financial advice might resonate with your entrepreneurial mindset, where decisions often hinge on investments and resource allocation.

- Realistic Expectations: Recognizing that most advice isn’t followed can help temper your expectations when giving feedback to your team or advice to friends, promoting a more understanding approach.

- Embrace Experimentation: In both your life and work, the article advocates for trying various approaches instead of clinging to conventional advice, validating the importance of trial and error in both parenting and business development.

## AI Summary (from Notion)
Advice often goes unheeded due to various reasons: it may be bad or incomplete, people might not understand it, or they lack the motivation to follow it. Additionally, personal experiences and differing perspectives can affect the applicability of advice, leading to a disconnect between the advice given and the advice followed. To improve the effectiveness of advice, both consumers and producers should have realistic expectations and focus on actionable, easy-to-follow guidance.
...
1. Maybe consider blindly following advice sometimes? If you’ve repeatedly made terrible choices in some domain, maybe try the wisdom of the crowds instead?
And for producers of advice:

1. Have realistic expectations. Most advice isn’t followed.
1. If you really want to have impact, focus on giving advice that is easy to follow.
