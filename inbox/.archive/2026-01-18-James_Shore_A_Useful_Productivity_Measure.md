...
tags: ['Running']
created: 2024-05-07T04:44:00.000Z
---

# James Shore: A Useful Productivity Measure?

## AI Summary (from Notion)
- Role of Productivity Measurement: The author, now VP of Engineering, faces pressure to measure productivity effectively in a software engineering context.
- Challenges of Measurement: Notable figures like Martin Fowler and Kent Beck argue that measuring software productivity is inherently difficult, if not impossible.
- Alternative Approach: Instead of focusing solely on productivity metrics, the author emphasizes accountability and qualitative discussions about engineering progress.
- Product Engineering Accountability Review: The author developed a review process based on indicators that reflect the desired state of the engineering organization rather than just numerical productivity measures.
- OKRs and Productivity Metrics: The company established an OKR to define and improve productivity metrics, leading to the exploration of profitability indicators like actual RoI, estimated RoI, and value-add capacity.
- Product Bets Concept: A “Product Bet” proposal system was introduced to prioritize engineering initiatives based on their expected value and accountability from leadership.
- Value-Add Capacity as a Measure: The current focus is on measuring "value-add capacity," which reflects the percentage of engineering time spent on activities that add value, as a proxy for productivity.
- Impact on Leadership Conversations: Presenting value-add capacity shifted discussions from project speed to understanding and reducing non-value-add activities (muda).
- Goodhart’s Law Warning: The author cautions that when a measure becomes a target, it ceases to be a good measure, highlighting the risk of manipulating metrics for favorable outcomes.
- Final Thoughts: Emphasizes the importance of delivering valuable software consistently, and encourages a focus on quality over mere productivity metrics.
