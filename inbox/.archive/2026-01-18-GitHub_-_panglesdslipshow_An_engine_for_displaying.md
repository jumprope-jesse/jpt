...
tags: ['Running']
created: 2024-05-29T12:04:00.000Z
---

# GitHub - panglesd/slipshow: An engine for displaying slips, the next-gen version of slides

## AI Summary (from Notion)
- Project Overview: Slipshow is an innovative presentation tool designed for technical presentations, addressing limitations of traditional slide presentations.
- Core Concept:
- Each slide in Slipshow is referred to as a slip, which can contain content of unlimited length.
- The presentation scrolls to reveal content instead of erasing previous information, allowing for continuity and better viewer comprehension.
- Key Features:
- Fixes issues with traditional slides by mimicking a blackboard presentation style.
- Utilizes easy-to-read syntax based on markdown with extensions.
- Enables dynamic presentations with annotations and animations.
- Technical Aspects:
- Compiles markdown files into standalone HTML files for offline viewing.
- Offers tools for both online and offline presentation creation.
- Challenges Addressed:
- Traditional slides often lead to information loss and viewer confusion.
- Slipshow allows presenters to keep previous information visible while introducing new content.
- Usage:
- Available for installation via opam or npm.
- Offers commands for compiling markdown files and auto-recompiling during edits.
- Community Contribution: Encourages users to contribute through pull requests, bug reports, and feature suggestions.
...
- The slips of my thesis, the very first presentation that used (a very early version of) slipshow,
- Some other technical presentation (that also used an early version of the engine)
