...
tags: ['Running']
created: 2024-02-18T16:04:00.000Z
---

# Observable 2.0 | Observable

## Overview (from Notion)
- Observable 2.0 introduces an open-source framework for building data apps, enhancing your ability to create polished, interactive dashboards—valuable for both personal and professional projects.
- The focus on a better user experience means less time waiting for data to load and more time making informed decisions—essential for managing family and business life.
- The framework’s flexibility with programming languages allows you to leverage existing skills in JavaScript, Python, or SQL, making it easier to adapt to various data sources and analyses.
- The emphasis on collaboration and effective communication through data can improve how you present ideas to stakeholders, furthering innovation in your company.
- Unique viewpoints include the idea that traditional notebooks aren't sufficient for polished applications, pushing the boundary of how data should be presented.
- Alternate views may argue that the simplicity of notebooks is more accessible for non-technical users; however, the enhanced capabilities of the framework could empower deeper insights for those willing to learn.
- The community aspect of Observable encourages sharing knowledge and best practices, fostering a supportive environment for continuous learning and improvement.

## AI Summary (from Notion)
Observable 2.0 introduces an open-source static site generator for creating fast and beautiful data apps, dashboards, and reports. It combines JavaScript for interactive graphics with various backend languages for data preparation. The framework addresses performance issues by precomputing data, ensuring instant page loads and enhanced security. It aims to improve developer workflows, user experience, and data architecture, allowing for seamless integration with existing tools and languages while fostering effective data communication within teams.
...
1. A better user experience — the “proof is in the pudding”
1. A better data architecture — solving the “last mile” problem
...
## Build better data apps, dashboards, and reports
