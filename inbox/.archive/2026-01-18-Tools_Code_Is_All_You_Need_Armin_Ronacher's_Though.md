...
tags: ['Running']
created: 2025-07-03T17:55:00.000Z
---

# Tools: Code Is All You Need | Armin Ronacher's Thoughts and Writings

## Overview (from Notion)
- The discussion on Multi-Component Pipelines (MCP) highlights the tension between automation and manual coding, relevant for streamlining your work processes as a software engineer and entrepreneur.
- Emphasizes the importance of code over inference for reliable automation, suggesting that writing scripts could be more efficient than relying on AI models for task completion.
- Suggests that while MCP may be the future, its current limitations make it less practical for repetitive tasks compared to traditional coding methods.
- The idea of using LLMs (Language Learning Models) to generate code can enhance productivity, potentially freeing up time for family and personal interests.
- Unique viewpoint: automation should focus on repetitive tasks for maximum efficiency, rather than one-off activities, which can resonate with a busy life managing work and family.
- Alternate view: MCP advocates may argue for the benefits of AI-driven automation in reducing the need for deep coding knowledge, making technology more accessible.
- Consider how this conversation about automation and coding tools can inform your decisions on software tools for your company, balancing between powerful automation and reliable code practices.

## AI Summary (from Notion)
MCP (Multi-Component Pipeline) has limitations in composability and context demand, making code generation a more efficient choice for automation tasks. Automation should focus on repetitive tasks to enhance productivity, and using code allows for better validation and reliability. The author advocates for bypassing MCP in favor of empowering LLMs to write code, suggesting that this could lead to more effective and scalable solutions in software development.
...
- talks
- about
If you've been following me on Twitter, you know I'm not a big fan of MCP right now. It's not that I dislike the idea; I just haven't found it to work as advertised. In my view, MCP suffers from two major flaws:

1. It isn’t truly composable. Most composition happens through inference.
1. It demands too much context. You must supply significant upfront input, and every tool invocation consumes even more context than simply writing and running code.
