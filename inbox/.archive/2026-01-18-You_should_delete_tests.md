...
tags: ['Running']
created: 2025-08-30T05:37:00.000Z
---

# You should delete tests

## Overview (from Notion)
- Embrace the idea that not all tests are valuable; sometimes, it's better to delete them for greater efficiency and clarity in your projects.
- Consider how flaky tests can lead to anxiety and wasted time—something you might relate to in both your professional and personal life when balancing work and family.
- Reflect on the importance of maintaining confidence in your codebase, akin to how you strive to maintain stability and reliability in family life.
- The notion of evolving standards can resonate with your parenting style; just as you adapt your approach as your children grow, your testing strategy should adapt to changing project needs.
- Alternate views might emphasize the importance of maintaining tests for historical context or future reference, but weigh this against the practical impacts on your daily workflow.
- Recognize that removing outdated tests can free up mental space, allowing you to focus on innovation and growth as a founder in a fast-paced environment like NYC.

## AI Summary (from Notion)
Tests should be deleted if they decrease confidence in code changes, such as flaky tests that fail randomly or require excessive updates. Keeping irrelevant or slow tests can harm productivity and confidence. It's better to remove ineffective tests and create new ones that accurately reflect current business requirements and functionality.
