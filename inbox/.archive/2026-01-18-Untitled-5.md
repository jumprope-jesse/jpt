...
type: link
source: notion
url: https://www.lesswrong.com/posts/DHkkL2GxhxoceLzua/thoughts-on-seed-oil
notion_type: Other
tags: ['Running']
created: 2024-04-21T01:14:00.000Z
---

# Untitled

## Overview (from Notion)
- Health Concerns: As a busy software engineer and founder, understanding the implications of your diet, especially regarding seed oils, can impact your long-term health and energy levels.
- Time Efficiency: The discussion on seed oils emphasizes the importance of convenience versus health—considering how quick meal options might be more harmful than beneficial.
- Family Nutrition: Your choices about cooking oils and processed foods can influence your family's eating habits and health, making this topic personally relevant.
- Challenging Norms: The piece challenges mainstream dietary guidelines; it encourages questioning established health narratives, which aligns with a critical, analytical mindset in tech.
- Complexity of Nutrition: Highlights the complexity of dietary science; it underlines the need for a nuanced understanding rather than black-and-white conclusions.
- Holistic Approach: The emphasis on overall diet quality rather than focusing solely on one component (like seed oils) suggests a more comprehensive approach to health—integrating exercise, mental well-being, and nutrition.
- Alternate Views: While the piece critiques seed oil theories, it acknowledges the need for more research, suggesting that the conversation is ongoing and complex, with room for differing opinions.
- Personal Experimentation: Encourages individual experimentation with diet—consider trying different fats and observing their effects on your energy and health, rather than adhering strictly to any one theory.

## AI Summary (from Notion)
Discussion on seed oils and their potential health impacts, exploring various arguments for and against their consumption, including processing methods, obesity correlations, and the complexity of dietary fats. The conclusion suggests skepticism towards strong claims about seed oils being the primary cause of health issues, advocating for overall dietary quality improvements instead.
...
For the last few decades, obesity (BMI ≥30) has grown at around . Clearly we are doing something wrong. We evolved to effortlessly stay at a healthy weight, but we’ve somehow broken our regulatory mechanisms. Anywhere people adopt a Western diet, the same thing happens.

Of course, the  is many things. But if you start reading ingredients lists, you’ll soon notice that everything has vegetable oil in it. Anything fried, obviously, but also instant noodles, chips, crackers, tortillas, cereal, energy bars, canned tuna, processed meats, plant-based meat, coffee creamer, broths, frozen dinners, salad dressing, and sauces. Also: Baby food, infant formula, and sometimes even ice cream or bread. People eat a lot more vegetable oil than they used to (figure from ):

Many vegetable oils (and particularly seed oils) are high in linoleic acid. And guess what’s making up a rapidly increasing fraction of body fat? (figure from ):
...
1. Maybe linoleic acid becomes oxidized LDL and thereby causes inflammation.
1. Maybe it’s the ratio of omega-6 to omega-3 fats you eat that matters.
1. Maybe vegetable oil doesn’t make you feel full like animal fats do, meaning vegetable oils lead to overeating.
1. Maybe vegetable oils have an increased propensity to become trans fats.
## On fat
...
Here’s a picture (simplified from ):
...
The double bonds in fatty acids have . They can be “normal” (cis) or they can be “reversed” in a way that leaves the rest of the fatty acid chain “flipped” (trans). (The Dynomight Biologist howls in protest at this description, but is overruled.)
...
That’s a shame because trans fats are pretty rare in nature (maybe 3% of butter/canola oil, around  of olive oil) and evolution doesn’t seem to have prepared us to eat large amounts of them. The WHO calls them “deadly”. It’s consensus that they cause obesity, diabetes, and heart disease, though the mechanism of harm often still isn’t understood. Trans fats started being phased out around the world about 25 years ago. But before that happened, they were estimated to cause 30k to 100k deaths per year in the United States.

So, don’t eat trans fats.

About that, bad news—if you cook with unsaturated fat at high temperature you can make your own trans fats right in your kitchen. Though it  not much happens if you stay below 200℃, and even with high temperatures and long times, it’s hard to get above 8%. Still, deep-frying with the same oil for days on end seems like a bad idea.
...
And if you want a monocausal story for every modern health problem, inflammation is a good mechanism. We have other cases where one source of inflammation causes a range of seemingly unrelated health problems (e.g. ).

Finally, seed oil theorists often suggest replacing unsaturated fat with saturated fat. This conflicts with the old consensus that saturated fat increases the risk of heart disease. But there seems to be increasing doubt about that old consensus . Many still defend it, but there’s real debate.
...
When humans build complex systems, we modularize, so we can understand what’s happening. But evolution is a lunatic. It doesn’t care about understanding. So biological systems tend to be spectacularly non-modularized. When I started reading  I almost felt like I wanted to throw up, what with all the exceptions to the exceptions to the exceptions.
...
All of these things are possible. Maybe . But the more such features a theory has, the less I trust it.
...
In analysis after analysis, it’s sitting there, being taken into account. Along with all the other studies, which mostly don’t support the same conclusion.  points out that the vegetable oil group got  which was high in trans fats. That could explain their poor results, but the other group was surely eating some trans fats too, and this kind of single-trial nitpicking makes me nervous.

### There’s no conspiracy against the Minnesota Coronary Survey either.

The Minnesota Coronary Survey ran from 1968 to 1973. There’s a story floating around that goes something like this: This was a huge trial with 9,423 subjects in nursing homes and mental hospitals. For the experimental group, they replaced saturated fat with vegetable oil rich in lionleic acid. They expected this to decrease heart disease, but when the opposite happened, the investigators just kind of dropped things. These “inconvenient” results were mostly ignored until 43 years later, when  came around and recovered the old data.

When I read this story I was pumping my fist. Fixing publication bias by scrounging up lost data from decades ago! Yes! But when I looked into the details, that story is mostly bogus. The main results of this trial have been available for decades. Here is Figure 6 from , which clearly shows that the control group does a bit better:

Some say that even if the results were published, they were ignored before Ramsden et al., but that’s not true either. Check the  if you want—most come before 2016.
...
The exclusion of this study is no conspiracy. Lots of trials where vegetable oils look great were also excluded. For example, the legendary  ran for 12 years and found that a similar (also weird) diet reduced heart disease by almost 50% and overall mortality by 11%. It was excluded because it used a crossover design rather than randomization.
...
give some long-term estimates of vegetable oil consumption: (Note the scale is smaller in the lower plot.)
...
There’s also data for the incoming classes at a couple military academies.  collects data for people entering  and :

Maybe West Point cadets got a little heavier? There’s a 20 year run, so at 0.05 BMI/year we’d only expect an increase of 1 BMI, close to what’s observed. But for the Citadel, if anything is decreasing.  give more Citadel data, stratified by the age of the students:
...
Not necessarily, no. But I decided to check anyway. I found the WHO provides some —the estimated fraction of the population that has a BMI of at least 30 by year. Here’s what that looked like in 2010.
...
Anyway, seed oil consumption data is harder to find, but  give estimates for 2010. Here’s estimated omega-6 consumption:
...
Is anything there? Maybe so, I’m not sure. I did the same for  and , which look about equally convincing. But if you put per-capita GDP on the x-axis…
...
But seed oil theorists mostly seem to push a much stronger theory: We know that seed oils are the cause of .
...
Again, I’m sure you can send me long lists of random citations. (You don’t need to send them; it’s OK; I’ve seen them already.) But for anything that’s been studied in detail, there’s always lots of evidence to support any semi-plausible view. Do you have any idea how much evidence people can produce for  or  or ?
