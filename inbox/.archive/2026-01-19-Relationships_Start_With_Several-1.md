...
tags: ['Running']
created: 2024-02-23T03:39:00.000Z
---

# Relationships: Start With Several

## AI Summary (from Notion)
- The post emphasizes the importance of starting with multiple relationships in system design, particularly One-To-Many relationships.
- Common mistakes include designing systems with One-To-One relationships, which can lead to complications when scaling.
- Many real-world situations are inherently polyrelational; starting with One-To-Many can accommodate future changes more easily.
- The transition from One-To-One to One-To-Many can be painful and complex, often requiring significant refactoring of existing code and systems.
- Starting with Many-To-Many relationships can add layers of complexity that may be difficult to manage.
- Scaling down from a One-To-Many to a One-To-One relationship is generally easier than the reverse.
- The author shares personal reflections on the tendency to underestimate the likelihood of needing to accommodate multiple relationships in future designs.
- The overall takeaway is that preferring to start with several relationships can save time and effort down the line.
