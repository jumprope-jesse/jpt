...
type: link
source: notion
url: https://docs.allauth.org/en/latest/release-notes/recent.html?utm_campaign=Django%2BNewsletter&utm_medium=rss&utm_source=Django_Newsletter_244
notion_type: Software Repo
tags: ['Running']
created: 2024-08-02T13:15:00.000Z
---

# 64.0.0 (2024-07-31) - django-allauth

## Overview (from Notion)
- The shift from version 0.x.y to 64.0.0 reflects a significant evolution in software development, symbolizing maturity—something that parallels personal growth and adaptation in life.
- Embracing WebAuthn and passkey login could enhance security in your projects, showing the importance of staying ahead in tech trends, especially relevant in today's cyber landscape.
- The introduction of new features like the serialize_user() method allows for deeper customization, much like how you tailor your parenting or business approach to meet unique challenges.
- The focus on backward compatibility and security notices highlights the importance of safeguarding your digital life, balancing innovation with caution—valuable lessons for both parenting and entrepreneurship.
- The ability to manage multiple social accounts efficiently resonates with juggling family, work, and personal life; it's about finding balance amidst complexity.
- Consider the implications of moving away from older software versions—it reflects a broader life lesson on letting go of outdated practices to embrace new opportunities.
- The emphasis on user experience in headless mode can inspire you to think about how design and functionality impact both your software and family life—efficiency can lead to more quality time.

## AI Summary (from Notion)
Version 64.0.0 introduces semantic versioning, support for WebAuthn security keys, and several headless mode improvements. Backwards incompatible changes include dropping support for Django 3.2 and Python 3.7. Noteworthy changes in previous versions include security fixes for XSS vulnerabilities and updates to account handling, including email notifications and Google One Tap Sign-In support. Email addresses are now stored in lowercase, and the rate limit mechanism has been updated for clarity and consistency.
...
- When the Facebook provider was configured to use the js_sdk method the login page could become vulnerable to an XSS attack.
# 0.63.5 (2024-07-11)
...
- The django-allauth required dependencies are now more fine grained. If you do not use any of the social account functionality, a pip install
django-allauth will, e.g., no longer pull in dependencies for handling JWT. If you are using social account functionality, install using pip install
"django-allauth[socialaccount]". That will install the dependencies covering most common providers. If you are using the Steam provider, install using pip
