...
type: link
source: notion
url: http://cadlag.org/posts/a-review-of-freedman-pisani-purves-statistics.html
notion_type: Tech Deep Dive
tags: ['Running']
created: 2024-12-01T15:55:00.000Z
---

# cadlag dot org - Statistics, by Freedman, Pisani, and Purves

## Content (from Notion)

Tags: statistics, book-review
...
1. Simple random sampling in this context would be impractical for several reasons, and so the Current Population Survey (a nationwide survey conducted by the Census Bureau) uses fairly sophisticated probability models in its design.
1. Estimating standard errors here is likewise more complicated than in the context of a simple random sample, but nonetheless the estimation can still be done in a coherent and principled manner.
...
1. David Freedman, Robert Pisani, and Roger Purves, Statistics, 4th ed.
